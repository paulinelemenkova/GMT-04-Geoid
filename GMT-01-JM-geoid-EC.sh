...
# Generate a file
ps=Geoid_EC.ps
gmt grdimage geoid_01.grd -Ccolors.cpt -R278/285/-5/1.5 -JM6.5i -P -Xc -I+a15+ne0.75 -K > $ps
gmt grdimage geoid_02.grd -Ccolors.cpt -R278/285/-5/1.5 -JM6.5i -P -Xc -I+a15+ne0.75 -O -K >> $ps
...
# Add legend
gmt psscale -Dg278/-5.5+w16.5c/0.4c+h+o0.0/0i+ml+e -R -J -Ccolors.cpt \
...
# Add subtitle
gmt pstext -R0/10/0/15 -JX10/10 -X0.1c -Y10.0c -N -O \
