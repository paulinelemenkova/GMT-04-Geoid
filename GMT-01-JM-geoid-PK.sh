...
gmt grdconvert n00e45/w001001.adf geoid_PK.grd
gdalinfo geoid_PK.grd -stats
...
# Generate a file
ps=Geoid_PK.ps
gmt grdimage geoid_PK.grd -Chaxby -R60.0/80.0/23.5/37.2 -JM6.5i -P -I+a15+ne0.75 -Xc -K > $ps

# Add shorelines
gmt grdcontour geoid_PK.grd -R -J -C1 -A1+f6p,Helvetica,black -Wthinnest,dimgray -O -K >> $ps
...
gmt psbasemap -R -J \
    ...
    --MAP_FRAME_AXES=WEsN \
    -B+t"Geoid gravitational regional model of Pakistan" \
...
3.0 8.9 World geoid image EGM2008 vertical datum 2.5 min resolution
EOF

# Convert to image file using GhostScript
gmt psconvert Geoid_PK.ps -A0.5c -E720 -Tj -Z
