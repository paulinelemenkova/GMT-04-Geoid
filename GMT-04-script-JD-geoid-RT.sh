...
# Equidistant conic projection (here: Ryukyu Trench). Small inserted World map: Eckert VI projection.
...
gmt grdimage geoid.egm96.grd -I+a45+nt1 \
    -R120/134/20/33 -JD127/24/27/30/6i -Cgeoid.cpt -P -K > $ps
# Step-5. Add basemap: grid, title, costline
gmt pscoast -R -J -P \
	-V -W0.25p \
    -Df -B+t"Geoid gravitational regional model: Ryukyu Trench area" \
	-Bxg3f4a2 -Byg3f2a2 \
    -O -K >> $ps
...
gmt psbasemap -R -J \
    ...
    -Lx13c/-2.4c+c50+w500k+l"Equidistant conic projection. Scale, km"+f \
    -UBL/-15p/-67p -O -K >> $ps
...
gmt psbasemap -R -J \
    ...
    --MAP_LABEL_OFFSET=0.1c \
    -Tmg131/23+w3.4c+d-14.5+t45/10/5+ithin,blue+p0.1p,red+l+jCM \
    -O -K >> $ps
...
10.0 0.0 Standard paralles at 24\232 and 30\232 N
END
# Step-14. Add text
...
gmt psconvert Geoid_RT.ps -A0.5c -E720 -Tj -Z
