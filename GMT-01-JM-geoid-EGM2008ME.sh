...
grdconvert cent2_geoid/ EGM2008ME.grd

grdconvert EGM2008ME.grd -GEGM2008ME.nc
gdalinfo EGM2008ME.nc -stats
# Minimum=-106.909, Maximum=46.727

gmt makecpt -Chaxby -T-107/47/1 > colors.cpt

# Generate a file
ps=Geoid_EGM2008.ps
gmt grdimage EGM2008ME.grd -Ccolors.cpt -R20/90/-5/60 -JM6i -P -I+a15+ne0.75 -Xc -K > $ps
...
gmt psbasemap -R -J \
    ...
    -B+t"EGM2008 Geoid gravitational regional model: Middle East region" \
    -Lx12.7c/-1.3c+c318/-57+w800k+l"Mercator projection. Scale: km"+f \
    -UBL/-5p/-40p -O -K >> $ps

# Add shorelines
gmt grdcontour EGM2008ME.grd -R -J -C2 -A2+f6p,Helvetica,black -Wthinnest,dimgray -O -K >> $ps
