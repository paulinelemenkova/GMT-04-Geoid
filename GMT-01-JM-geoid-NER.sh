...
# Make raster image
gmt grdimage EGM2008ner1.grd -Ccolors.cpt -R65/107/-35/21 -JM6i -P -I+a15+ne0.75 -Xc -K > $ps
gmt grdimage EGM2008ner2.grd -Ccolors.cpt -R65/107/-35/21 -JM6i -P -I+a15+ne0.75 -Xc -O -K >> $ps
gmt grdimage EGM2008ner3.grd -Ccolors.cpt -R65/107/-35/21 -JM6i -P -I+a15+ne0.75 -Xc -O -K >> $ps
gmt grdimage EGM2008ner4.grd -Ccolors.cpt -R65/107/-35/21 -JM6i -P -I+a15+ne0.75 -Xc -O -K >> $ps
...
gmt psbasemap -R -J \
    ...
    -B+t"Geoid geopotential model: Ninety East Ridge region, Indian Ocean" -O -K >> $ps
...
2.0 13.5 Global geoid image EGM2008-WGS84 2,5 minute resolution
EOF
