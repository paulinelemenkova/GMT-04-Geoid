...
# gmt makecpt --help
gmt makecpt -Cseis -T-65/81/1 -Ic > colors.cpt
gmt makecpt -Cseis -T-67/77/1 -Ic > colors1.cpt
# haxby

# Generate a file
ps=Geoid_ST.ps
gmt grdimage geoid_ST.grd -Ccolors.cpt -R90/130/-20/10 -JPoly/6i -P -I+a15+ne0.75 -Xc -K > $ps
gmt grdimage geoid_ST1.grd -Ccolors1.cpt -R90/130/-20/10 -JPoly/6i -P -I+a15+ne0.75 -Xc -O -K >> $ps
#gmt grdimage geoid_ST96.grd -Ccolors.cpt -R90/130/-20/10 -JPoly/6i -P -I+a15+ne0.75 -Xc -K > $ps
...
gmt psbasemap -R -J \
    ...
    -Lx13.0c/-2.2c+c318/-57+w800k+l"Polyconic projection. Scale: km"+f \
    -UBL/0p/-65p -O -K >> $ps
    
gmt psscale -Dg92.0/-22+w11.4c/0.4c+h+o0.3/0i+ml -R -J -Ccolors.cpt \
