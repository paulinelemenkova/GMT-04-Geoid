...
grdconvert n00w90/ EGM2008cs.grd

gdalinfo EGM2008cs.grd -stats
# Minimum=-32.535, Maximum=65.174
# makecpt --help
# Select a color palette
#gdalinfo geoid.egm96.grd -stats
# Minimum=-32.0, Maximum=66.6, Mean=-0.808, StdDev=29.198
...
gmt grdimage EGM2008cs.grd -Ccolors.cpt -R270/305/7/24 -JM6i -P -I+a15+ne0.75 -Xc -K > $ps
...
# Add shorelines
gmt grdcontour EGM2008cs.grd -R270/305/7/24 -JM6i -C1 -A5 -W0.1p -O -K >> $ps
...
gmt psscale -Dg265.5/7+w7.7c/0.4c+v+o0.3/0i+ml -R270/305/7/24 -J -Ccolors.cpt \
    ...
    -Ba20f2+l"Color scale: Bill Haxby's color scheme for geoid & gravity [C=RGB]" \
    -I0.2 -By+lm -O -K >> $ps
...
3.0 4.2 World geoid image EGM2008 2.5 minute resolution
EOF
